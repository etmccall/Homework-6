...
# Use the Python map function on the programmers list you just created, in order to create an map instance iterator of numbers representing 
##the productivity of each student. Save the map iterator in a variable called prod_iter.
...
def readfiles(filenames):
    for f in filenames:
        ...
        for line in fileref: 
            yield line
        fileref.close() # Important to do this for later-on code...
        
print(type(readfiles))
file_names_list = ["samplehw6_1.txt", "samplehw6_2.txt"] # fill in strings that represent filenames in this list...
#print(list(readfiles(file_names_list)))
